...
SECRET_KEY = 'django-insecure-kr*dnfb^wk8q33qgk9$vi3d24ep(ze7c0q*d8i23lf)ods=c^&'
...
# Optional: tell graphene where the schema lives (not required if you pass schema to the view)
GRAPHENE = {
